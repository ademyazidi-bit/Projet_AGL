...
$workout_info = [
    'Weight Loss'     => ['sets' => 3, 'reps' => 15, 'duration' => '40 sec', 'rest' => '30 sec'],
    'Muscle Gain'     => ['sets' => 4, 'reps' => 8,  'duration' => null,     'rest' => '90 sec'],
    'Maintain Weight' => ['sets' => 3, 'reps' => 12, 'duration' => '30 sec', 'rest' => '60 sec'],
];
...
$exercise_data = [
    'Bench Press' => [
        ...
        'mistakes'     => ["Don't bounce the bar off your chest", "Keep your feet flat on the floor", "Don't flare elbows too wide"],
        'calories'     => 35,
    ],
    'Push Up' => [
        'description'  => 'A bodyweight exercise that targets chest, shoulders, and triceps.',
        'secondary'    => 'Triceps, Core',
        'mistakes'     => ["Don't let your back sag", "Keep elbows at 45 degrees", "Don't drop your hips"],
        'calories'     => 25,
    ],
    'Incline Dumbbell Press' => [
        'description'  => 'An upper chest focused press performed on an inclined bench.',
        'secondary'    => 'Front Deltoids, Triceps',
        'mistakes'     => ["Don't set the incline too high", "Keep wrists straight", "Control the descent"],
        'calories'     => 30,
    ],
    'Cable Fly' => [
        'description'  => 'An isolation exercise that stretches and contracts the chest muscles.',
        'secondary'    => 'Front Deltoids',
        'mistakes'     => ["Don't use too much weight", "Keep a slight bend in elbows", "Don't let cables pull you back"],
        'calories'     => 28,
    ],
    'Dips' => [
        'description'  => 'A bodyweight exercise targeting the chest and triceps.',
        'secondary'    => 'Triceps, Shoulders',
        'mistakes'     => ["Don't lock elbows at top", "Lean forward for chest focus", "Control the descent"],
        'calories'     => 32,
    ],
    'Pull Up' => [
        'description'  => 'A compound pulling exercise that builds back width and bicep strength.',
        'secondary'    => 'Biceps, Core',
        'mistakes'     => ["Don't use momentum", "Go all the way down", "Keep core tight"],
        'calories'     => 35,
    ],
    'Deadlift' => [
        'description'  => 'The king of compound movements targeting the entire posterior chain.',
        'secondary'    => 'Glutes, Hamstrings, Traps',
        'mistakes'     => ["Don't round your lower back", "Keep bar close to body", "Drive through your heels"],
        'calories'     => 50,
    ],
    'Bent Over Row' => [
        'description'  => 'A compound back exercise performed by rowing a barbell toward your torso.',
        'secondary'    => 'Biceps, Rear Deltoids',
        'mistakes'     => ["Don't round your back", "Keep torso at 45 degrees", "Don't use momentum"],
        'calories'     => 38,
    ],
    'Lat Pulldown' => [
        'description'  => 'A cable machine exercise that targets the latissimus dorsi muscles.',
        'secondary'    => 'Biceps, Rear Deltoids',
        'mistakes'     => ["Don't lean back too far", "Pull to upper chest not neck", "Control the return"],
        'calories'     => 28,
    ],
    'Seated Cable Row' => [
        'description'  => 'A seated cable exercise targeting the middle and lower back.',
        'secondary'    => 'Biceps, Rear Deltoids',
        'mistakes'     => ["Don't round your back", "Keep elbows close", "Don't use legs to pull"],
        'calories'     => 28,
    ],
    'Squat' => [
        'description'  => 'The fundamental lower body exercise targeting quads, glutes and hamstrings.',
        'secondary'    => 'Hamstrings, Core',
        'mistakes'     => ["Don't let knees cave in", "Keep chest up", "Go to at least parallel"],
        'calories'     => 45,
    ],
    'Leg Press' => [
        'description'  => 'A machine exercise that targets the quads, hamstrings and glutes.',
        'secondary'    => 'Hamstrings, Glutes',
        'mistakes'     => ["Don't lock knees at top", "Keep lower back flat", "Don't place feet too low"],
        'calories'     => 35,
    ],
    'Lunges' => [
        'description'  => 'A unilateral leg exercise targeting quads and glutes.',
        'secondary'    => 'Hamstrings, Glutes, Core',
        'mistakes'     => ["Don't let front knee pass toes", "Keep torso upright", "Control each step"],
        'calories'     => 32,
    ],
    'Romanian Deadlift' => [
        'description'  => 'A hip hinge movement targeting the hamstrings and glutes.',
        'secondary'    => 'Lower Back, Glutes',
        'mistakes'     => ["Don't round your back", "Keep bar close to legs", "Feel the stretch in hamstrings"],
        'calories'     => 40,
    ],
    'Calf Raises' => [
        'description'  => 'An isolation exercise for the calf muscles.',
        'secondary'    => 'Soleus',
        'mistakes'     => ["Don't bounce at the bottom", "Go through full range of motion", "Hold at the top"],
        'calories'     => 18,
    ],
    'Overhead Press' => [
        'description'  => 'A compound shoulder exercise pressing a barbell overhead.',
        'secondary'    => 'Triceps, Upper Chest',
        'mistakes'     => ["Don't arch your lower back", "Keep core braced", "Press in a straight line"],
        'calories'     => 35,
    ],
    'Lateral Raise' => [
        'description'  => 'An isolation exercise targeting the side deltoids.',
        'secondary'    => 'Traps',
        'mistakes'     => ["Don't swing the weights", "Keep slight bend in elbows", "Don't raise above shoulder height"],
        'calories'     => 20,
    ],
    'Front Raise' => [
        'description'  => 'An isolation exercise targeting the front deltoids.',
        'secondary'    => 'Upper Chest',
        'mistakes'     => ["Don't use momentum", "Keep core tight", "Control the descent"],
        'calories'     => 20,
    ],
    'Arnold Press' => [
        'description'  => 'A shoulder press with rotation targeting all three deltoid heads.',
        'secondary'    => 'Triceps, Upper Chest',
        'mistakes'     => ["Don't rush the rotation", "Keep elbows in front at start", "Control every rep"],
        'calories'     => 28,
    ],
    'Face Pull' => [
        'description'  => 'A cable exercise targeting the rear deltoids and rotator cuff.',
        'secondary'    => 'Rear Deltoids, Traps',
        'mistakes'     => ["Don't use too much weight", "Pull to face level", "Externally rotate at the end"],
        'calories'     => 20,
    ],
    'Bicep Curl' => [
        'description'  => 'The classic isolation exercise for the biceps.',
        'secondary'    => 'Forearms',
        'mistakes'     => ["Don't swing your body", "Keep elbows stationary", "Control the descent"],
        'calories'     => 20,
    ],
    'Tricep Pushdown' => [
        'description'  => 'A cable exercise isolating the triceps.',
        'secondary'    => 'Forearms',
        'mistakes'     => ["Keep elbows close to sides", "Don't lean forward too much", "Fully extend at the bottom"],
        'calories'     => 20,
    ],
    'Hammer Curl' => [
        'description'  => 'A curl variation targeting the biceps and brachialis.',
        'secondary'    => 'Forearms, Brachialis',
        'mistakes'     => ["Keep elbows stationary", "Don't swing", "Control the descent"],
        'calories'     => 20,
    ],
    'Skull Crushers' => [
        'description'  => 'A lying tricep extension exercise using a barbell.',
        'secondary'    => 'Forearms',
        'mistakes'     => ["Don't flare elbows out", "Lower with control", "Keep upper arms vertical"],
        'calories'     => 22,
    ],
    'Concentration Curl' => [
        'description'  => 'A seated isolation curl for peak bicep contraction.',
        'secondary'    => 'Forearms',
        'mistakes'     => ["Don't swing the dumbbell", "Fully extend at bottom", "Squeeze hard at top"],
        'calories'     => 18,
    ],
    'Plank' => [
        'description'  => 'A static core exercise that builds stability and endurance.',
        'secondary'    => 'Shoulders, Glutes',
        'mistakes'     => ["Don't let hips sag", "Don't raise hips too high", "Breathe steadily"],
        'calories'     => 15,
    ],
    'Crunches' => [
        'description'  => 'A basic abdominal exercise targeting the rectus abdominis.',
        'secondary'    => 'Hip Flexors',
        'mistakes'     => ["Don't pull on your neck", "Keep lower back on floor", "Focus on contracting abs"],
        'calories'     => 15,
    ],
    'Russian Twist' => [
        'description'  => 'A rotational core exercise targeting the obliques.',
        'secondary'    => 'Hip Flexors, Rectus Abdominis',
        'mistakes'     => ["Don't round your back", "Keep feet off the floor", "Rotate from the torso"],
        'calories'     => 20,
    ],
    'Leg Raises' => [
        'description'  => 'A core exercise targeting the lower abdominals.',
        'secondary'    => 'Hip Flexors',
        'mistakes'     => ["Don't swing legs", "Lower slowly", "Keep lower back pressed to floor"],
        'calories'     => 18,
    ],
    'Ab Wheel Rollout' => [
        'description'  => 'An advanced core exercise using an ab wheel for full core engagement.',
        'secondary'    => 'Shoulders, Lats',
        'mistakes'     => ["Don't let hips sag", "Go as far as you can control", "Brace your core throughout"],
        'calories'     => 25,
    ],
    'Running' => [
        'description'  => 'A fundamental cardio exercise that burns calories and builds endurance.',
        'secondary'    => 'Glutes, Hamstrings, Core',
        'mistakes'     => ["Don't overstride", "Keep arms relaxed", "Land midfoot not on heel"],
        'calories'     => 60,
    ],
    'Jump Rope' => [
        'description'  => 'A high intensity cardio exercise that improves coordination and burns fat.',
        'secondary'    => 'Calves, Shoulders, Core',
        'mistakes'     => ["Don't jump too high", "Keep elbows close", "Land softly on balls of feet"],
        'calories'     => 55,
    ],
    'Burpees' => [
        'description'  => 'A full body cardio exercise combining a squat, push up and jump.',
        'secondary'    => 'Chest, Core, Legs',
        'mistakes'     => ["Don't sag in the plank", "Land softly from the jump", "Keep a consistent pace"],
        'calories'     => 65,
    ],
    'Cycling' => [
        'description'  => 'A low impact cardio exercise great for endurance and fat burning.',
        'secondary'    => 'Hamstrings, Glutes, Calves',
        'mistakes'     => ["Adjust seat height properly", "Don't lock knees", "Keep a steady cadence"],
        'calories'     => 50,
    ],
    'Box Jumps' => [
        'description'  => 'An explosive plyometric exercise building power and burning calories.',
        'secondary'    => 'Glutes, Hamstrings, Core',
        'mistakes'     => ["Land with soft knees", "Don't jump down hard", "Fully extend at the top"],
        'calories'     => 55,
    ],
    'Kettlebell Swing' => [
        'description'  => 'A dynamic full body exercise driven by hip extension.',
        'secondary'    => 'Hamstrings, Core, Shoulders',
        'mistakes'     => ["Don't squat the swing", "Drive with hips not arms", "Keep back flat"],
        'calories'     => 50,
    ],
    'Thruster' => [
        'description'  => 'A combination squat and overhead press for full body conditioning.',
        'secondary'    => 'Triceps, Core, Glutes',
        'mistakes'     => ["Don't pause between squat and press", "Keep core tight", "Drive through heels"],
        'calories'     => 60,
    ],
    'Mountain Climbers' => [
        'description'  => 'A full body cardio move performed in a plank position.',
        'secondary'    => 'Core, Shoulders, Hip Flexors',
        'mistakes'     => ["Don't raise hips", "Keep hips level", "Maintain a fast steady pace"],
        'calories'     => 45,
    ],
    'Clean and Press' => [
        'description'  => 'An Olympic lift combining a power clean and overhead press.',
        'secondary'    => 'Traps, Core, Glutes',
        'mistakes'     => ["Don't use arms to pull", "Catch with bent knees", "Press in one fluid motion"],
        'calories'     => 60,
    ],
    'Battle Ropes' => [
        'description'  => 'A full body conditioning exercise using heavy ropes.',
        'secondary'    => 'Core, Shoulders, Arms',
        'mistakes'     => ["Don't stand too upright", "Keep core engaged", "Maintain rhythm throughout"],
        'calories'     => 55,
    ],
];
    ...
    <?php else: ?>
        ...
        <div class="exercise-card <?php echo $i === 0 ? 'active' : ''; ?>" id="card-<?php echo $i; ?>">
                ...
                <div class="info-grid">
                    ...
                    <div class="info-box">
                        <?php if ($isCardio && $info['duration']): ?>
                            <div class="val"><?php echo $info['duration']; ?></div>
                    ...
                    <div class="info-box">
                        <div class="val" style="color:#f39c12;"><?php echo $data ? $data['calories'] : '~30'; ?></div>
                        <div class="lbl">Cal/set</div>
                    </div>
                </div>
            ...
            <div class="nav-buttons">
                ...
                <?php else: ?>
                    <a href="workout_generator.html" class="btn btn-secondary">← Change Goal</a>
                <?php endif; ?>
                ...
                <?php else: ?>
                    <a href="workout_generator.html" class="btn btn-success">Done!</a>
                <?php endif; ?>
            </div>
        </div>
        <?php endforeach; ?>
